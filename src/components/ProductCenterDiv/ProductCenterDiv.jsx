    ...
    <StyledDiv>
      ...
      <div style={{ display: "inline-block" }}>
        ...
        <p>
          ...
          refreshments from the rooftop bar, and chill out in the big lounge
          style couches. You will find good space to move around, which makes it
          easier to find a perfect shot of the capital's skyline - with
          architectural highlights like Palacio de Cibeles and the Metropolis
          building.
        </p>
      </div>
